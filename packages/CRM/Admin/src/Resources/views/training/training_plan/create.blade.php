...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        ...
        <div class="page-header">
            ...
            {{ Breadcrumbs::render('training.training_plan.create') }}

            <div class="page-title">
                <h1>{{ __('admin::app.training.training_plan.create-title') }}</h1>
            </div>
        </div>

        {!! view_render_event('admin.contacts.persons.create.header.after') !!}

        <form method="POST" action="{{ route('admin.training_plan.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
