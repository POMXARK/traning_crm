...
//
        ...
        $this->loadTranslationsFrom($crmPath . '/Resources/lang', 'admin');
        //$this->loadTranslationsFrom(__DIR__ . '/../Resources/lang', 'admin');

        $this->loadViewsFrom(__DIR__ . '/../Resources/views', 'admin');

        // закомментирован для явного показа ошибок
//        $this->app->bind(\Illuminate\Contracts\Debug\ExceptionHandler::class, \Webkul\Admin\Exceptions\Handler::class);
    ...
    {
        $crmPath = __DIR__  . '/../../../../CRM/Admin/src';
        //dd('__DIR__ : ' . realpath($crmPath));

        $this->mergeConfigFrom($crmPath . '/Config/acl.php', 'acl');
//        $this->mergeConfigFrom(dirname(__DIR__) . '/Config/acl.php', 'acl');

        $this->mergeConfigFrom($crmPath . '/Config/menu.php', 'menu.admin');
//        $this->mergeConfigFrom(dirname(__DIR__) . '/Config/menu.php', 'menu.admin');
        ...
        $this->mergeConfigFrom($crmPath . '/Config/attribute_lookups.php', 'attribute_lookups');
