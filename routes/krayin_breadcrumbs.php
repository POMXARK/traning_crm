...
// Dashboard > Contacts > Clients > Create
Breadcrumbs::for('contacts.clients.create', function (BreadcrumbTrail $trail) {
    $trail->parent('contacts.clients');
    $trail->push(trans('admin::app.contacts.persons.create-title'), route('admin.contacts.clients.create'));
});

// Dashboard > Contacts > Clients > Edit
Breadcrumbs::for('contacts.clients.edit', function (BreadcrumbTrail $trail, $person) {
    $trail->parent('contacts.clients');
    $trail->push(trans('admin::app.contacts.persons.edit-title'), route('admin.contacts.clients.edit', $person->id));
});